...
def major_checking():
    ...
    time.sleep(2)
    section = driver.find_elements(By.CSS_SELECTOR, "section.uw-contained-width uw-section-spacing--default uw-section-separator--none uw-column-separator--none uw-section-alignment--top-align-content layout layout--uw-3-col even-split".replace(" ", "."))[1]
